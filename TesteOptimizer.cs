...
namespace GEO
{
    public class TesteOptimizer
    {
        ...
        public static double ObjectiveFunction(int I, int N, int D){
            ...
            Propulsion p = new Propulsion(20000, (0.15).DegreesToRadians(), Ss_orb, Deorbit);
        ...
        public static void Main(string[] args){
            ...
            double fx = ObjectiveFunction(14,49,50);
