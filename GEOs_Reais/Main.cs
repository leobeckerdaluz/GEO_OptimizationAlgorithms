...
//                 int quantidade_NFOBs = retornos_execucoes_AGEOreal1[0].melhores_NFOBs.Count;
//                 Console.WriteLine("");
//                 for(int i=0; i<quantidade_NFOBs; i++){
//                     double sum1 = 0.0;
//                     foreach(RetornoGEOs ret in retornos_execucoes_GEOreal1){
//                         sum1 += ret.melhores_NFOBs[i];
//                     }
//                     double media_NFOBs1 = sum1 / quantidade_execucoes;
//                     string media_str1 = (media_NFOBs1.ToString()).Replace('.',',');
//                     Console.WriteLine(media_str1);
//                 }
