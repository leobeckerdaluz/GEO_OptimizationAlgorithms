...
{
    public class AGEOs_REAL : GEOsBASE_REAL
    {
        ...
        public AGEOs_REAL(double tau, int n_variaveis_projeto, int definicao_funcao_objetivo, List<RestricoesLaterais> restricoes_laterais, int step_obter_NFOBs, double std, int tipo_AGEO) : base(tau, n_variaveis_projeto, definicao_funcao_objetivo, restricoes_laterais, step_obter_NFOBs, std)
        {
