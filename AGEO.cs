...
namespace AGEO
{
    ...
    */
    ...
    /*
        Classe principal contendo os algoritmos AGEO
    */
    public class AGEO
    {
        ...
        */
        ...
        /*
            A função AGEO é a função principal do código. Aqui nesse bloco toda a lógica implementada para os algoritmos
            AGEO1 e AGEO2 é implementada, como a geração da população, o controle do critério de parada e a
            avaliação do flip de cada bit.
            A função retorna o melhor f(x) da execução.
        */
        public static List<double> AGEO_algorithm(int tipo_GEO, int tipo_ageo, int n_variaveis_projeto, List<int> bits_por_variavel_variaveis, int definicao_funcao_objetivo, List<double> limites_inferiores_variaveis, List<double> limites_superiores_variaveis, double valor_criterio_parada, List<int> NFOBs, double fx_esperado, int CRITERIO_PARADA_NFOBouPRECISAO){  
            ...
            while (true){
                ...
                if (tipo_ageo == 1){
                    informacoes_mutacao_AGEO = obtem_lista_deltaV_se_flipar_comparando_com(melhor_fx, populacao_de_bits, definicao_funcao_objetivo, n_variaveis_projeto, limites_inferiores_variaveis, limites_superiores_variaveis, bits_por_variavel_variaveis);
                }
                else if (tipo_ageo == 2){
                ...
                if (CoI == 0){
                    ...
                    // Console.WriteLine("============================");
                    // Console.WriteLine("INCREASE TAO. Rand gerado: {0}", rand);
                    // Console.WriteLine("============================");
