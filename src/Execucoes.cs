...
namespace Execucoes
{
    public class Execucoes_GEO
    {
        ...
        public void Execucoes(){
            ...
            // ======================================================================
            int definicao_funcao_objetivo = (int)EnumNomesFuncoesObjetivo.ackley;
