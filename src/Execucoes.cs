...
namespace Execucoes
{
    public class Execucoes_GEO
    {
        ...
        public static RetornoGEOs Executa_Algoritmo_por_N_vezes(ParametrosExecucao parametros_execucao, ParametrosProblema parametros_problema, int qual_algoritmo_executar){
            ...
            for(int i=0; i<parametros_execucao.quantidade_execucoes; i++){
                ...
                switch(qual_algoritmo_executar){
                    ...
                    case (int)EnumNomesAlgoritmos.GEO_can:
                        ...
                        retorno_algoritmo = geo.executar(parametros_execucao.parametros_criterio_parada);
                    ...
                    case (int)EnumNomesAlgoritmos.GEO_var:
                        ...
                        retorno_algoritmo = geo_var.executar(parametros_execucao.parametros_criterio_parada);
                    ...
                    case (int)EnumNomesAlgoritmos.AGEO1:
                        ...
                        retorno_algoritmo = ageo1.executar(parametros_execucao.parametros_criterio_parada);
                    ...
                    case (int)EnumNomesAlgoritmos.AGEO2:
                        ...
                        retorno_algoritmo = ageo2.executar(parametros_execucao.parametros_criterio_parada);
                    ...
                    case (int)EnumNomesAlgoritmos.AGEO1var:
                        ...
                        retorno_algoritmo = ageo1_var.executar(parametros_execucao.parametros_criterio_parada);
                    ...
                    case (int)EnumNomesAlgoritmos.AGEO2var:
                        ...
                        retorno_algoritmo = ageo2_var.executar(parametros_execucao.parametros_criterio_parada); 

                        break;
                    
                    case (int)EnumNomesAlgoritmos.GEOreal1:
                        GEO_real1 geo_real1 = new GEO_real1(parametros_problema.parametros_livres.tau_GEOreal1, parametros_problema.n_variaveis_projeto, parametros_problema.definicao_funcao_objetivo, parametros_problema.restricoes_laterais_por_variavel, parametros_execucao.parametros_criterio_parada.step_para_obter_NFOBs, parametros_problema.parametros_livres.std_GEOreal1, 0);
                        
                        retorno_algoritmo = geo_real1.executar(parametros_execucao.parametros_criterio_parada);

                        break;

                    case (int)EnumNomesAlgoritmos.AGEO1real1:
                        AGEOs_REAL1 AGEO1real1 = new AGEOs_REAL1(parametros_problema.parametros_livres.tau_minimo_AGEOs, parametros_problema.n_variaveis_projeto, parametros_problema.definicao_funcao_objetivo, parametros_problema.restricoes_laterais_por_variavel, parametros_execucao.parametros_criterio_parada.step_para_obter_NFOBs, parametros_problema.parametros_livres.std_AGEO1real1, 1, 0);
                        
                        retorno_algoritmo = AGEO1real1.executar(parametros_execucao.parametros_criterio_parada);
                    ...
                    case (int)EnumNomesAlgoritmos.AGEO2real1:
                        ...
                        retorno_algoritmo = AGEO2real1.executar(parametros_execucao.parametros_criterio_parada);

                        break;

                    case (int)EnumNomesAlgoritmos.GEOreal2:
                        GEO_real2 geo_real2 = new GEO_real2(parametros_problema.parametros_livres.tau_GEOreal2, parametros_problema.n_variaveis_projeto, parametros_problema.definicao_funcao_objetivo, parametros_problema.restricoes_laterais_por_variavel, parametros_execucao.parametros_criterio_parada.step_para_obter_NFOBs, parametros_problema.parametros_livres.std_GEOreal2, 0, (int)parametros_problema.parametros_livres.P_GEOreal2);
                        
                        retorno_algoritmo = geo_real2.executar(parametros_execucao.parametros_criterio_parada);

                        break;

                    case (int)EnumNomesAlgoritmos.AGEO1real2:
                        AGEOs_REAL2 AGEO1real2 = new AGEOs_REAL2(parametros_problema.parametros_livres.tau_minimo_AGEOs, parametros_problema.n_variaveis_projeto, parametros_problema.definicao_funcao_objetivo, parametros_problema.restricoes_laterais_por_variavel, parametros_execucao.parametros_criterio_parada.step_para_obter_NFOBs, parametros_problema.parametros_livres.std_AGEO1real2, 1, 0, (int)parametros_problema.parametros_livres.P_AGEO1real2);
                        
                        retorno_algoritmo = AGEO1real2.executar(parametros_execucao.parametros_criterio_parada);

                        break;
                        
                    case (int)EnumNomesAlgoritmos.AGEO2real2:
                        AGEOs_REAL2 AGEO2real2 = new AGEOs_REAL2(parametros_problema.parametros_livres.tau_minimo_AGEOs, parametros_problema.n_variaveis_projeto, parametros_problema.definicao_funcao_objetivo, parametros_problema.restricoes_laterais_por_variavel, parametros_execucao.parametros_criterio_parada.step_para_obter_NFOBs, parametros_problema.parametros_livres.std_AGEO2real2, 2, 0, (int)parametros_problema.parametros_livres.std_AGEO2real2);
                        
                        retorno_algoritmo = AGEO2real2.executar(parametros_execucao.parametros_criterio_parada);

                        break;


                    case (int)EnumNomesAlgoritmos.GEOreal3:
                        GEO_real3 geo_real3 = new GEO_real3(parametros_problema.parametros_livres.tau_GEOreal3, parametros_problema.n_variaveis_projeto, parametros_problema.definicao_funcao_objetivo, parametros_problema.restricoes_laterais_por_variavel, parametros_execucao.parametros_criterio_parada.step_para_obter_NFOBs, parametros_problema.parametros_livres.std_GEOreal3, 0, (int)parametros_problema.parametros_livres.P_GEOreal3);
                        
                        retorno_algoritmo = geo_real3.executar(parametros_execucao.parametros_criterio_parada);

                        break;
                    
                    case (int)EnumNomesAlgoritmos.AGEO1real3:
                        AGEOs_REAL2 AGEO1real3 = new AGEOs_REAL2(parametros_problema.parametros_livres.tau_minimo_AGEOs, parametros_problema.n_variaveis_projeto, parametros_problema.definicao_funcao_objetivo, parametros_problema.restricoes_laterais_por_variavel, parametros_execucao.parametros_criterio_parada.step_para_obter_NFOBs, parametros_problema.parametros_livres.std_AGEO1real3, 1, 0, (int)parametros_problema.parametros_livres.P_AGEO1real3);
                        
                        retorno_algoritmo = AGEO1real3.executar(parametros_execucao.parametros_criterio_parada);

                        break;
                        
                    case (int)EnumNomesAlgoritmos.AGEO2real3:
                        AGEOs_REAL2 AGEO2real3 = new AGEOs_REAL2(parametros_problema.parametros_livres.tau_minimo_AGEOs, parametros_problema.n_variaveis_projeto, parametros_problema.definicao_funcao_objetivo, parametros_problema.restricoes_laterais_por_variavel, parametros_execucao.parametros_criterio_parada.step_para_obter_NFOBs, parametros_problema.parametros_livres.std_AGEO2real3, 2, 0, (int)parametros_problema.parametros_livres.std_AGEO2real3);
                        
                        retorno_algoritmo = AGEO2real3.executar(parametros_execucao.parametros_criterio_parada);
            ...
            media_das_execucoes.algoritmo_utilizado = qual_algoritmo_executar;
        ...
        public static void Executa_Os_Algoritmos_Por_N_Vezes(ParametrosProblema parametros_problema, ParametrosExecucao parametros_execucao){
            ...
            RetornoGEOs retorno_GEOreal3 = new RetornoGEOs();
            RetornoGEOs retorno_AGEO1real3 = new RetornoGEOs();
            RetornoGEOs retorno_AGEO2real3 = new RetornoGEOs();
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_GEO){
                ...
                retorno_GEO = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.GEO_can);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_GEOvar){
                ...
                retorno_GEOvar = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.GEO_var);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1){
                ...
                retorno_AGEO1 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO1);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2){
                ...
                retorno_AGEO2 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO2);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1var){
                ...
                retorno_AGEO1var = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO1var);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2var){
                ...
                retorno_AGEO2var = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO2var);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal1){
                ...
                retorno_GEOreal1 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.GEOreal1);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal2){
                ...
                retorno_GEOreal2 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.GEOreal2);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real1){
                ...
                retorno_AGEO1real1 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO1real1);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real1){
                ...
                retorno_AGEO2real1 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO2real1);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real2){
                ...
                retorno_AGEO1real2 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO1real2);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real2){
                ...
                retorno_AGEO2real2 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO2real2);
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal3){
                ...
                retorno_GEOreal3 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.GEOreal3);

                quantidade_NFOBs = retorno_GEOreal3.melhores_NFOBs.Count;
            }
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real3){
                ...
                retorno_AGEO1real3 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO1real3);

                quantidade_NFOBs = retorno_AGEO1real3.melhores_NFOBs.Count;
            }
            ...
            if (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real3){
                ...
                retorno_AGEO2real3 = Executa_Algoritmo_por_N_vezes(parametros_execucao, parametros_problema, (int)EnumNomesAlgoritmos.AGEO2real3);

                quantidade_NFOBs = retorno_AGEO2real3.melhores_NFOBs.Count;
            }
            ...
            if (parametros_execucao.o_que_interessa_printar.mostrar_melhores_NFOB){
                ...
                for(int i=0; i<quantidade_NFOBs; i++){
                    ...
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_GEO) ? (retorno_GEO.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOvar) ? (retorno_GEOvar.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1) ? (retorno_AGEO1.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2) ? (retorno_AGEO2.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1var) ? (retorno_AGEO1var.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2var) ? (retorno_AGEO2var.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal1) ? (retorno_GEOreal1.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal2) ? (retorno_GEOreal2.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real1) ? (retorno_AGEO1real1.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real1) ? (retorno_AGEO2real1.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real2) ? (retorno_AGEO1real2.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real2) ? (retorno_AGEO2real2.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal3) ? (retorno_GEOreal3.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real3) ? (retorno_AGEO1real3.melhores_NFOBs[i].ToString()+';') : "";
                    fxs_naquele_NFOB += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real3) ? (retorno_AGEO2real3.melhores_NFOBs[i].ToString()+';') : "";
            ...
            if (parametros_execucao.o_que_interessa_printar.mostrar_media_NFE_atingido){
                ...
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEO) ? (retorno_GEO.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOvar) ? (retorno_GEOvar.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1) ? (retorno_AGEO1.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2) ? (retorno_AGEO2.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1var) ? (retorno_AGEO1var.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2var) ? (retorno_AGEO2var.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal1) ? (retorno_GEOreal1.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal2) ? (retorno_GEOreal2.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real1) ? (retorno_AGEO1real1.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real1) ? (retorno_AGEO2real1.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real2) ? (retorno_AGEO1real2.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real2) ? (retorno_AGEO2real2.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal3) ? (retorno_GEOreal3.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real3) ? (retorno_AGEO1real3.NFOB.ToString()+';') : "";
                media_do_NFE_atingido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real3) ? (retorno_AGEO2real3.NFOB.ToString()+';') : "";
            ...
            if (parametros_execucao.o_que_interessa_printar.mostrar_media_melhor_fx){
                ...
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEO) ? (retorno_GEO.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOvar) ? (retorno_GEOvar.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1) ? (retorno_AGEO1.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2) ? (retorno_AGEO2.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1var) ? (retorno_AGEO1var.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2var) ? (retorno_AGEO2var.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal1) ? (retorno_GEOreal1.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal2) ? (retorno_GEOreal2.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real1) ? (retorno_AGEO1real1.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real1) ? (retorno_AGEO2real1.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real2) ? (retorno_AGEO1real2.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real2) ? (retorno_AGEO2real2.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal3) ? (retorno_GEOreal3.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real3) ? (retorno_AGEO1real3.melhor_fx.ToString()+';') : "";
                media_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real3) ? (retorno_AGEO2real3.melhor_fx.ToString()+';') : "";
            ...
            if (parametros_execucao.o_que_interessa_printar.mostrar_SD_melhor_fx){
                ...
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEO) ? (retorno_GEO.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOvar) ? (retorno_GEOvar.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1) ? (retorno_AGEO1.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2) ? (retorno_AGEO2.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1var) ? (retorno_AGEO1var.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2var) ? (retorno_AGEO2var.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal1) ? (retorno_GEOreal1.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal2) ? (retorno_GEOreal2.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real1) ? (retorno_AGEO1real1.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real1) ? (retorno_AGEO2real1.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real2) ? (retorno_AGEO1real2.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real2) ? (retorno_AGEO2real2.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_GEOreal3) ? (retorno_GEOreal3.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO1real3) ? (retorno_AGEO1real3.SD_melhor_fx.ToString()+';') : "";
                SD_do_melhor_FX_obtido_nas_execucoes += (parametros_execucao.quais_algoritmos_rodar.rodar_AGEO2real3) ? (retorno_AGEO2real3.SD_melhor_fx.ToString()+';') : "";
        ...
        public static void Execucoes(){
            ...
            // ======================================================================
            int definicao_funcao_objetivo = (int)EnumNomesFuncoesObjetivo.rosenbrock;
            ...
            ParametrosExecucao parametros_execucao = new ParametrosExecucao(){
                ...
                parametros_criterio_parada = new ParametrosCriterioParada(){
                    ...
                    step_para_obter_NFOBs = 10,
                    NFOB_criterio_parada = 500,
                    fx_esperado = 0.0
                },
                quais_algoritmos_rodar = new QuaisAlgoritmosRodar(){
                    ...
                    rodar_GEOreal2      = true,
                    rodar_AGEO1real2    = true,
                    rodar_AGEO2real2    = true,
            ...
            Executa_Os_Algoritmos_Por_N_Vezes(parametros_problema, parametros_execucao);
